...
<body>
	...
	<div class="banner">
		<h3>Exchange: Poloniex / Trading pair: ZEC/AUD</h3>
	</div>
	<div class="holding_form">
		<h4>Add ZCash to your portfolio</h4>
		
		<form action="portfolio.php" method="post">
			ZCash holdings:&nbsp; <input type="number" step="any" min="0" name="amount_zcash"><br><br>
			<input type="submit" value="Add" name="amount_zcash_sub">
		</form>
