...
<body>
	...
	<div class="banner">
		<h3>Exchange: Poloniex / Trading pair: LTC/AUD</h3>
	</div>
	<div class="holding_form">
		<h4>Add Litecoin to your portfolio</h4>
		
		<form action="portfolio.php" method="post">
			Litecoin holdings:&nbsp; <input type="number" step="any" min="0" name="amount_litecoin"><br><br>
			<input type="submit" value="Add" name="amount_litecoin_sub">
		</form>
