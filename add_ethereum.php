...
<body>
	...
	<div class="banner">
		<h3>Exchange: Poloniex / Trading pair: ETH/AUD</h3>
	</div>
	<div class="holding_form">
		<h4>Add Ethereum to your portfolio</h4>
		
		<form action="portfolio.php" method="post">
			Ethereum holdings:&nbsp; <input type="number" step="any" min="0" name="amount_ethereum"><br><br>
			<input type="submit" value="Add" name="amount_ethereum_sub">
		</form>
