...
<meta name="viewport" content="width=device-width,height=device-height,initial-scale=1.0"/>
	...
	<div class="banner">
		<h3>Exchange: Poloniex / Trading pair: NXT/AUD</h3>
	</div>
	<div class="holding_form">
		<h4>Add NXT to your portfolio</h4>
		
		<form action="portfolio.php" method="post">
			NXT holdings:&nbsp; <input type="number" step="any" min="0" name="amount_nxt"><br><br>
			<input type="submit" value="Add" name="amount_nxt_sub">
		</form>
