...
<body>
	...
	<div class="banner">
		<h3>Exchange: Poloniex / Trading pair: DASH/AUD</h3>
	</div>
		<div class="holding_form">
		<h4>Add Dash to your portfolio</h4>
		
		<form action="portfolio.php" method="post">
			Dash holdings:&nbsp; <input type="number" step="any" min="0" name="amount_dash"><br><br>
			<input type="submit" value="Add" name="amount_dash_sub">
		</form>
