...
<body>
	...
	<div class="banner">
		<h3>Exchange: Poloniex / Trading pair: BCH/AUD</h3>
	</div>
	<div class="holding_form">
		<h4>Add Bitcoincash to your portfolio</h4>
		
		<form action="portfolio.php" method="post">
			bitcoincash holdings:&nbsp; <input type="number" step="any" min="0" name="amount_bitcoincash"><br><br>
			<input type="submit" value="Add" name="amount_bitcoincash_sub">
		</form>
