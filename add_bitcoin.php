...
<meta name="viewport" content="width=device-width,height=device-height,initial-scale=1.0"/>
	...
	<div class="banner">
		<h3>Exchange: Poloniex / Trading pair: BTC/AUD</h3>
	</div>
	<div class="holding_form">
		<h4>Add Bitcoin to your portfolio</h4>
		
		<form action="portfolio.php" method="post">
			Bitcoin holdings:&nbsp; <input type="number" step="any" min="0" name="amount_bitcoin"><br><br>
			<input type="submit" value="Add" name="amount_bitcoin_sub">
		</form>
